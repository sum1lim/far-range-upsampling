...
log_file = open("./checkpoints/exp1_train.log", "w")
...
model = nn.DataParallel(model1(batch_size=BS, device=device)).to(device)
...
for epoch in range(epochs):
    ...
    try:
        ...
        train_acc = metrics.balanced_accuracy_score(train_true_class, train_pred_class)
    except ValueError:
        train_mae = "NaN"
    ...
    if test_loss < best_test_loss:
        ...
        torch.save(model.state_dict(), "checkpoints/exp1_model.pt")
