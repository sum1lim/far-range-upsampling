...
python train.py --exp-name exp15 --model model1 --loss combined --focal-thresh 2500 --focal-weight 0.1 --KNNstep 1
python train.py --exp-name exp16 --model model1 --loss combined --focal-thresh 2500 --focal-weight 0.2 --KNNstep 1
python train.py --exp-name exp17 --model model1 --loss combined --focal-thresh 2500 --focal-weight 0.4 --KNNstep 1
python train.py --exp-name exp18 --model model1 --loss combined --focal-thresh 2500 --focal-weight 0.8 --KNNstep 1